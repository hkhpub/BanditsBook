...
results <- read.csv("python/algorithms/epsilon_greedy/standard_results.tsv", sep="\t", header = FALSE)
# results <- read.csv("python/algorithms/epsilon_greedy/normal_dist_results.tsv", sep="\t", header = FALSE)
